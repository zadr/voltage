...
- (void) dump {
	[self powerSourceDetailForKey:CFSTR(kIOPSPowerAdapterIDKey)];
	[self powerSourceDetailForKey:CFSTR(kIOPSPowerAdapterWattsKey)];
	[self powerSourceDetailForKey:CFSTR(kIOPSPowerAdapterRevisionKey)];
	[self powerSourceDetailForKey:CFSTR(kIOPSPowerAdapterSerialNumberKey)];
	[self powerSourceDetailForKey:CFSTR(kIOPSPowerAdapterFamilyKey)];
	[self powerSourceDetailForKey:CFSTR(kIOPSPowerAdapterCurrentKey)];
	[self powerSourceDetailForKey:CFSTR(kIOPSPowerAdapterSourceKey)];
	[self powerSourceDetailForKey:CFSTR(kIOPSUPSManagementClaimed)];
	[self powerSourceDetailForKey:CFSTR(kIOPSLowWarnLevelKey)];
	[self powerSourceDetailForKey:CFSTR(kIOPSDeadWarnLevelKey)];
	[self powerSourceDetailForKey:CFSTR(kIOPSDynamicStorePath)];
	[self powerSourceDetailForKey:CFSTR(kIOPSCommandDelayedRemovePowerKey)];
	[self powerSourceDetailForKey:CFSTR(kIOPSCommandEnableAudibleAlarmKey)];
	[self powerSourceDetailForKey:CFSTR(kIOPSCommandStartupDelayKey)];
	[self powerSourceDetailForKey:CFSTR(kIOPSCommandSetCurrentLimitKey)];
	[self powerSourceDetailForKey:CFSTR(kIOPSCommandSetRequiredVoltageKey)];
	[self powerSourceDetailForKey:CFSTR(kIOPSCommandSendCurrentStateOfCharge)];
	[self powerSourceDetailForKey:CFSTR(kIOPSPowerSourceIDKey)];
	[self powerSourceDetailForKey:CFSTR(kIOPSPowerSourceStateKey)];
	[self powerSourceDetailForKey:CFSTR(kIOPSCurrentCapacityKey)];
	[self powerSourceDetailForKey:CFSTR(kIOPSMaxCapacityKey)];
	[self powerSourceDetailForKey:CFSTR(kIOPSDesignCapacityKey)];
	[self powerSourceDetailForKey:CFSTR(kIOPSNominalCapacityKey)];
	[self powerSourceDetailForKey:CFSTR(kIOPSTimeToEmptyKey)];
	[self powerSourceDetailForKey:CFSTR(kIOPSTimeToFullChargeKey)];
	[self powerSourceDetailForKey:CFSTR(kIOPSIsChargingKey)];
	[self powerSourceDetailForKey:CFSTR(kIOPSInternalFailureKey)];
	[self powerSourceDetailForKey:CFSTR(kIOPSIsPresentKey)];
	[self powerSourceDetailForKey:CFSTR(kIOPSVoltageKey)];
	[self powerSourceDetailForKey:CFSTR(kIOPSCurrentKey)];
	[self powerSourceDetailForKey:CFSTR(kIOPSTemperatureKey)];
	[self powerSourceDetailForKey:CFSTR(kIOPSNameKey)];
	[self powerSourceDetailForKey:CFSTR(kIOPSTypeKey)];
	[self powerSourceDetailForKey:CFSTR(kIOPSTransportTypeKey)];
	[self powerSourceDetailForKey:CFSTR(kIOPSVendorIDKey)];
	[self powerSourceDetailForKey:CFSTR(kIOPSProductIDKey)];
	[self powerSourceDetailForKey:CFSTR(kIOPSVendorDataKey)];
	[self powerSourceDetailForKey:CFSTR(kIOPSBatteryHealthKey)];
	[self powerSourceDetailForKey:CFSTR(kIOPSBatteryHealthConditionKey)];
	[self powerSourceDetailForKey:CFSTR(kIOPSBatteryFailureModesKey)];
	[self powerSourceDetailForKey:CFSTR(kIOPSHealthConfidenceKey)];
	[self powerSourceDetailForKey:CFSTR(kIOPSMaxErrKey)];
	[self powerSourceDetailForKey:CFSTR(kIOPSIsChargedKey)];
	[self powerSourceDetailForKey:CFSTR(kIOPSIsFinishingChargeKey)];
	[self powerSourceDetailForKey:CFSTR(kIOPSHardwareSerialNumberKey)];
	[self powerSourceDetailForKey:CFSTR(kIOPSSerialTransportType)];
	[self powerSourceDetailForKey:CFSTR(kIOPSUSBTransportType)];
	[self powerSourceDetailForKey:CFSTR(kIOPSNetworkTransportType)];
	[self powerSourceDetailForKey:CFSTR(kIOPSInternalType)];
	[self powerSourceDetailForKey:CFSTR(kIOPSInternalBatteryType)];
	[self powerSourceDetailForKey:CFSTR(kIOPSUPSType)];
	[self powerSourceDetailForKey:CFSTR(kIOPSOffLineValue)];
	[self powerSourceDetailForKey:CFSTR(kIOPSACPowerValue)];
	[self powerSourceDetailForKey:CFSTR(kIOPSBatteryPowerValue)];
	[self powerSourceDetailForKey:CFSTR(kIOPSPoorValue)];
	[self powerSourceDetailForKey:CFSTR(kIOPSFairValue)];
	[self powerSourceDetailForKey:CFSTR(kIOPSGoodValue)];
	[self powerSourceDetailForKey:CFSTR(kIOPSCheckBatteryValue)];
	[self powerSourceDetailForKey:CFSTR(kIOPSPermanentFailureValue)];
	[self powerSourceDetailForKey:CFSTR(kIOPSFailureExternalInput)];
	[self powerSourceDetailForKey:CFSTR(kIOPSFailureSafetyOverVoltage)];
	[self powerSourceDetailForKey:CFSTR(kIOPSFailureChargeOverTemp)];
	[self powerSourceDetailForKey:CFSTR(kIOPSFailureDischargeOverTemp)];
	[self powerSourceDetailForKey:CFSTR(kIOPSFailureCellImbalance)];
	[self powerSourceDetailForKey:CFSTR(kIOPSFailureChargeFET)];
	[self powerSourceDetailForKey:CFSTR(kIOPSFailureDischargeFET)];
	[self powerSourceDetailForKey:CFSTR(kIOPSFailureDataFlushFault)];
	[self powerSourceDetailForKey:CFSTR(kIOPSFailurePermanentAFEComms)];
	[self powerSourceDetailForKey:CFSTR(kIOPSFailurePeriodicAFEComms)];
	[self powerSourceDetailForKey:CFSTR(kIOPSFailureChargeOverCurrent)];
	[self powerSourceDetailForKey:CFSTR(kIOPSFailureDischargeOverCurrent)];
	[self powerSourceDetailForKey:CFSTR(kIOPSFailureOpenThermistor)];
	[self powerSourceDetailForKey:CFSTR(kIOPSFailureFuseBlown)];
}
@end
